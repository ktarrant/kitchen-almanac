...
def test_wishlist_entries_can_be_confirmed_or_kept_custom(catalog_client: TestClient) -> None:
...
def test_wishlist_rejects_empty_input(catalog_client: TestClient) -> None:
    response = catalog_client.post("/api/wishlists", json={"text": " \n "})
